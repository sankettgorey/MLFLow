...
dagshub.init(repo_owner='sankettg23', repo_name='MLFLow', mlflow=True)
mlflow.set_tracking_uri("https://dagshub.com/sankettg23/MLFLow.mlflow")
...
with mlflow.start_run():
    ...
    mlflow.set_tags({
        "author": "Sanket",
        "details": "experiment on mlflow functionality"
    })


    mlflow.sklearn.log_model(rf, "Random Forest")

# mlflow.delete_run("run-id")